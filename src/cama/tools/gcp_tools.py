...
from ..lib.gcp_handler import fetch_and_format_gcp_logs


class GCPLogIngestionTool(BaseTool):
    """CrewAI tool to fetch and format GCP Cloud Audit logs.
    ...
    name: str = "gcp_log_ingestion_tool"
    description: str = (
        "Fetch and group GCP Cloud Audit logs by methodName for the given number of days. "
    ...
    def _run(self, days: str) -> str:  # type: ignore[override]
        ...
        return fetch_and_format_gcp_logs(days_int)
